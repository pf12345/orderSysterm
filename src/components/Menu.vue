  ...
  <div class="">
    <Menu :theme="theme3" width="240px" @on-select="selectItem">
                ...
                <Submenu name="2">
                    ...
                    <Menu-item v-if="!user.jurisdictions || user.jurisdictions.indexOf('入住间夜数统计') != -1" name="2-3">入住间夜数统计</Menu-item>
                ...
                <Submenu name="4" v-if="!user.jurisdictions || user.jurisdictions.indexOf('数据监控及记录保存') != -1">
                  ...
                  <Menu-item name="4-1">当日价格监控记录簿</Menu-item>
                  <Menu-item name="4-2">重大销售策略调整记录表</Menu-item>
                ...
                <Submenu name="6">
                  ...
                  <Menu-item name="6-2" v-if="!user.jurisdictions || user.jurisdictions.indexOf('酒店管理') != -1 || user.name === 'admin'">酒店管理</Menu-item>
                  <Menu-item name="6-3" v-if="!user.jurisdictions || user.jurisdictions.indexOf('平台管理') != -1 || user.name === 'admin'">平台管理</Menu-item>
                </Submenu>
            </Menu>
  </div>
</template>
